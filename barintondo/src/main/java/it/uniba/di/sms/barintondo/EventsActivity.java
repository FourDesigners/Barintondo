...
import it.uniba.di.sms.barintondo.utils.EventoAdapter;
...
public class EventsActivity extends AppCompatActivity implements Constants, EventoAdapter.ItemsAdapterListener {
    ...
    private String requestCat = REQUEST_GET_EVENTS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new EventoAdapter(this, eventoList, this);
        ...
        controller.getEventiList( requestCat, eventoList, mAdapter);
    }
    ...
    @Override
    public void onItemsSelected(Evento item) {
