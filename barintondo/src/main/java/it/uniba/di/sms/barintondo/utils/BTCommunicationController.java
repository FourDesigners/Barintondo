...
public class BTCommunicationController {
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                tmp = bluetoothAdapter.listenUsingInsecureRfcommWithServiceRecord(nameUUID, MY_UUID);
        ...
        public void run() {
            ...
            while (state != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BTCommunicationController.this) {
                        switch (state) {
                            case STATE_LISTEN:
    ...
    private class ReadWriteThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                handler.obtainMessage(CouponDetailActivity.MESSAGE_WRITE, -1, -1,
                        buffer).sendToTarget();
            } catch (IOException e) {
            }
        }
